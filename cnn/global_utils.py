...
def parse_cmd_options(argv):
    ...
    parser.add_argument('--load_embedding', default='', help='load_embedding from checkpoint')

    # xuan:
    parser.add_argument('--seed', default=1, type=int, help='seed')
    parser.add_argument('--lottery', default="", type=str, help='path to lottery model')
    parser.add_argument('--random', action='store_true')
    parser.add_argument('--base-keep-rate', default=0.3, type=float, help='base_keep_rate')

    opt, _ = parser.parse_known_args(argv)
    if opt.dist_mode == "distribute":
