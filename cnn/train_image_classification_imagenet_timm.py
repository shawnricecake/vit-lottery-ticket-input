...
def main():
    ...
    try:
        if args.distributed:
            if args.local_rank == 0:
                torch.save(model.module.state_dict(), "{}/seed{}_initial_model.pth".format(args.output, args.seed))
...
def train_one_epoch(
    ...
    for batch_idx, (input, target) in enumerate(loader):
        ...
        with amp_autocast():
            ...
            if args.lottery and lottery_pretrained_model is not None:
                outputs = lottery_pretrained_model(input, keep_rate=args.base_keep_rate)
                all_index_record = []
                ...
                input = go_back_original_input_with_zero(index=total_original_index,
