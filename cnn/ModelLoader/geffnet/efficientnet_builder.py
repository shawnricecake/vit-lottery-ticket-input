...
class EfficientNetBuilder:
    ...
    def _make_block(self, ba):
        ...
        if 'fake_in_chs' in ba and ba['fake_in_chs']:
            # hisFIXME this is a hack to work around mismatch in origin impl input filters for EdgeTPU
...
def _decode_block_str(block_str):
    ...
    Raises:
        ValueError: if the string def not properly specified (hisTODO)
    """
    ...
    fake_in_chs = int(options['fc']) if 'fc' in options else 0  # hisFIXME hack to deal with in_chs issue in TPU def
