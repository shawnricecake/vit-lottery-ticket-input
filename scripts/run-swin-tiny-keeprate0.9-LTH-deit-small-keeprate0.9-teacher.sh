...
save_path="../checkpoints/exp-swin-tiny-keeprate0.9-LTH-deit-small-keeprate0.9-teacher"
mkdir -p $save_path
...
python3 -m torch.distributed.launch --nproc_per_node=8 \
        ...
        --output ${save_path} \
        --data-path ${data_path} \
> ../scripts/exp-swin-tiny-keeprate0.9-LTH-deit-small-keeprate0.9-teacher.txt 2>&1 &
